...
object BankSystem {
  def main(args: Array[String]): Unit = {
    val account1 = new Account("123456", 1000.0)  // Create account1 with a balance of 1000
    val account2 = new Account("654321", 500.0)   // Create account2 with a balance of 500
